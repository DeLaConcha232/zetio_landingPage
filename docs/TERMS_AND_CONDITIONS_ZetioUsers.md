# Términos y Condiciones — Zetio

**Última actualización:** 11 de agosto de 2026

Estos Términos y Condiciones ("Términos") regulan el uso de la aplicación móvil Zetio y los servicios asociados (el "Servicio"), operados por Diego Diaz ("nosotros", "nuestro" o "Zetio"). Al crear una cuenta, usar el Servicio en Modo Invitado, o de cualquier otra forma acceder a Zetio, aceptas estos Términos. Si no estás de acuerdo, no utilices el Servicio.

Estos Términos deben leerse junto con nuestra [Política de Privacidad](https://zetio.app/privacy), que describe cómo tratamos tus datos personales y que forma parte integral de este acuerdo por referencia.

> **Alcance de este documento — Zetio Users.** Estos Términos cubren los productos orientados a jugadores y coaches individuales: **Zetio Tour**, **Zetio Play** y **Zetio Coach**. Los Términos de **Zetio Clubs** (dirigido a administradores de clubes/canchas) se documentarán en una sección separada dentro de este mismo documento cuando ese producto esté disponible.
...
- **Zetio Coach** — gestión de la relación entre coaches y jugadores: agenda de sesiones, partidos supervisados y métricas deportivas.

Zetio es una **herramienta de organización y registro**. No somos dueños ni operadores de clubes, canchas o instalaciones deportivas, no empleamos a los coaches que usan la plataforma, y no somos parte de los acuerdos económicos entre organizadores, clubes, coaches o jugadores (ver Sección 9).

---

## 2. Elegibilidad y cuentas

- Debes tener **al menos 13 años** para crear una cuenta. Conforme al Código Civil Federal, la mayoría de edad en México se alcanza a los 18 años; si tienes entre 13 y 17 años, **declaras contar con la autorización de tu padre, madre o tutor legal** para usar el Servicio y para que dicho tutor acepte estos Términos en tu nombre, en los mismos términos descritos en la Sección 7 de nuestra Política de Privacidad.
...
- Puedes usar Zetio Play en **Modo Invitado**, sin crear una cuenta, en los términos descritos en la Sección 1.5 de nuestra Política de Privacidad. Algunas funciones (torneos estructurados, Zetio Coach, historial permanente) requieren una cuenta registrada.
...
## 3. Reglas específicas de Zetio Tour

- Los torneos publicados en Zetio son creados y administrados por el **organizador del torneo** (que puede ser Zetio o un club/organizador autorizado). Como jugador, te inscribes a torneos ya publicados; hoy la creación de torneos no es una función de autoservicio para jugadores.
...
- Las fechas, sedes, canchas, fases de grupos y llaves de eliminatoria son publicadas por el organizador del torneo. **Zetio no garantiza la disponibilidad de canchas, el cumplimiento del calendario publicado, ni la exactitud de la información logística** — esto depende del club o de quien administre el torneo en cuestión.
...
## 4. Reglas específicas de Zetio Play

- Cualquier persona con un **código de invitación** válido puede unirse a una reta, incluyendo mediante Modo Invitado. Eres responsable de con quién compartes tus códigos.
- El usuario que crea una reta (**host**) puede reemplazar o quitar a cualquier participante distinto de sí mismo en cualquier momento, incluso después de que la reta haya comenzado. Esta facultad, sus alcances y sus consecuencias para el participante removido están descritos en detalle en la Sección 1.3 de nuestra Política de Privacidad, y al unirte a una reta como jugador vinculado o por código de invitación, **aceptas que el host conserva esta facultad** sobre la reta que organiza.
...
## 5. Reglas específicas de Zetio Coach

- La relación entre un coach y un jugador dentro de Zetio requiere un **vínculo aceptado explícitamente** por el jugador (o su tutor legal si es menor de edad), como se describe en la Sección 1.6 de nuestra Política de Privacidad.
- **Zetio no verifica credenciales, certificaciones ni la calidad del coaching** de los usuarios que usan el rol de coach dentro de la plataforma. La relación de enseñanza, sus términos económicos y su idoneidad son responsabilidad exclusiva del coach y del jugador (o su tutor legal).
- El registro de sesiones como "pendiente" o "pagada" dentro de Zetio Coach es una **herramienta de seguimiento interna** entre coach y jugador; Zetio no procesa, garantiza ni interviene en ningún pago real (ver Sección 9).
...
Al usar Zetio, te comprometes a no:
...
Si detectas una conducta indebida de otro usuario, contáctanos a **soporte@zetio.app**. Hoy no existe un sistema de reporte dentro de la app; este correo es el canal disponible.
...
Si tienes preguntas sobre estos Términos, escríbenos a **soporte@zetio.app**.
